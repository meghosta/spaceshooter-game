...
if (typeof gdjs.evtsExt__VibratingCamera__VibrateCameraAroundPosition !== "undefined") {
  gdjs.evtsExt__VibratingCamera__VibrateCameraAroundPosition.registeredGdjsCallbacks.forEach(callback =>
...
gdjs.evtsExt__VibratingCamera__VibrateCameraAroundPosition.conditionTrue_1.val = eventsFunctionContext.getOnceTriggers().triggerOnce(9023532);
}
}if (gdjs.evtsExt__VibratingCamera__VibrateCameraAroundPosition.condition0IsTrue_0.val) {
{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "CameraVibrationTimer");
}}
...
gdjs.evtsExt__VibratingCamera__VibrateCameraAroundPosition.registeredGdjsCallbacks = [];